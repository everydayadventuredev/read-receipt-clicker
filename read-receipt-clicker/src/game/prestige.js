...
export const SKILL_TREE_NODES = [
  // ── ROOT 已讀覺醒 (4 nodes, 10✦) ──
  {
    id: 'st-r1', name: '快速啟動', desc: '重生後自帶100已讀',
    cost: 2, emoji: '🚀', branch: 'root', tier: 1, requires: [],
  ...
  },
  {
    ...
    cost: 3, emoji: '🧊', branch: 'root', tier: 1, requires: ['st-r1'],
    effect: { type: 'costDiscount', value: 0.05 },
  },
  {
    id: 'st-r4', name: '分支覺醒', desc: '全域產能再+10%',
    cost: 3, emoji: '🌀', branch: 'root', tier: 1, requires: ['st-r2'],
    effect: { type: 'globalMult', value: 1.10 },
  },

  // ── PRODUCTION 冷漠生產線 (8 nodes, ~400✦) ──
  {
    id: 'st-p1', name: '前任記憶', desc: '前任產能永久+50%',
    cost: 6, emoji: '💔', branch: 'production', tier: 2, requires: ['st-r4'],
  ...
  },
  {
    ...
    cost: 10, emoji: '🙏', branch: 'production', tier: 2, requires: ['st-p1'],
    effect: { type: 'buildingMult', target: 'par', value: 1.5 },
  },
  {
    id: 'st-p4', name: '職場冷漠', desc: '公司HR、前輩產能+50%',
    cost: 10, emoji: '💼', branch: 'production', tier: 2, requires: ['st-p2'],
    effects: [
  ...
  },
  {
    ...
    cost: 25, emoji: '🖥️', branch: 'production', tier: 3, requires: ['st-p3', 'st-p4'],
    effect: { type: 'globalMult', value: 1.25 },
  },
  {
    id: 'st-p6', name: '演算法調教', desc: '演算法、網紅產能+50%',
    cost: 30, emoji: '📊', branch: 'production', tier: 3, requires: ['st-p5'],
    effects: [
  ...
  },
  {
    ...
    cost: 70, emoji: '🧠', branch: 'production', tier: 4, requires: ['st-p6'],
    effects: [
  ...
  // ── META 超維已讀 (6 nodes, ~680✦) ──
  {
    id: 'st-m1', name: '深層已讀', desc: '重生獲得的✦+50%',
    cost: 20, emoji: '🔮', branch: 'meta', tier: 3, requires: ['st-r4'],
    effect: { type: 'prestigeBonus', value: 0.5 },
  },
  {
    id: 'st-m2', name: '星際外交', desc: '外星通訊、平行自我產能+50%',
    cost: 30, emoji: '🛸', branch: 'meta', tier: 3, requires: ['st-m1'],
    effects: [
  ...
  },
  {
    ...
    cost: 55, emoji: '⏳', branch: 'meta', tier: 4, requires: ['st-m2'],
    effects: [
