export const UPGRADES = [
  ...
  { id: 'e5',  name: '前任文明',       desc: '前任×1.5 — 前任們建立了自己的社會制度', type: 'm', target: 'ex', bonus: 1.5, cost: 1500000,    req: { building: 'ex', count: 50 },  emoji: '💔' },
  { id: 'e6',  name: '前任宇宙',       desc: '前任×1.5 — 你的前任比星星還多', type: 'm', target: 'ex', bonus: 1.5, cost: 15000000,   req: { building: 'ex', count: 100 }, emoji: '💔' },
  ...
  { id: 'p_5', name: '全家都已讀',     desc: '爸媽×1.5 — 連狗都學會已讀了', type: 'm', target: 'par', bonus: 1.5, cost: 10000000,   req: { building: 'par', count: 50 },  emoji: '👨‍👩‍👧‍👦' },
  { id: 'p_6', name: '祖宗十八代已讀', desc: '爸媽×1.5 — 連祖先牌位都顯示已讀', type: 'm', target: 'par', bonus: 1.5, cost: 100000000,  req: { building: 'par', count: 100 }, emoji: '🏛️' },
  ...
  { id: 'b5', name: '社交恐懼症候群', desc: '忙朋友x1.5 — 看到未接來電就心跳加速', type: 'm', target: 'bsy', bonus: 1.5, cost: 50000000,    req: { building: 'bsy', count: 50 },  emoji: '😱' },
  { id: 'b6', name: '孤獨的終極形態', desc: '忙朋友x1.5 — 終於不用為不回覆找藉口了', type: 'm', target: 'bsy', bonus: 1.5, cost: 500000000,   req: { building: 'bsy', count: 100 }, emoji: '🕳️' },
  ...
  { id: 'h5', name: '無薪假量產線',   desc: 'HRx1.5 — 你的薪水也被已讀了', type: 'm', target: 'hr', bonus: 1.5, cost: 300000000,   req: { building: 'hr', count: 50 },  emoji: '🏭' },
  { id: 'h6', name: '勞基法黑洞',     desc: 'HRx1.5 — 任何法規進去就出不來', type: 'm', target: 'hr', bonus: 1.5, cost: 3000000000,  req: { building: 'hr', count: 100 }, emoji: '⚖️' },
  ...
  { id: 'd5', name: '差評湮滅引擎',     desc: '外送x1.5 — 一星評價通通變成五星', type: 'm', target: 'del', bonus: 1.5, cost: 1500000000,   req: { building: 'del', count: 50 },  emoji: '💥' },
  { id: 'd6', name: '外送員已超越時空',  desc: '外送x1.5 — 你點餐之前就已經送到了', type: 'm', target: 'del', bonus: 1.5, cost: 15000000000,  req: { building: 'del', count: 100 }, emoji: '🚀' },
  ...
  { id: 'g5', name: '行政效率悖論', desc: '承辦x1.5 — 越多流程越有效率（？）', type: 'm', target: 'gov', bonus: 1.5, cost: 8000000000,    req: { building: 'gov', count: 50 },  emoji: '🔄' },
  { id: 'g6', name: '國家級已讀',   desc: '承辦x1.5 — 國家安全等級的已讀通知', type: 'm', target: 'gov', bonus: 1.5, cost: 80000000000,   req: { building: 'gov', count: 100 }, emoji: '🏛️' },
  ...
  { id: 'i5', name: '歐威爾認證',     desc: '情報x1.5 — 老大哥在看你已讀', type: 'm', target: 'int', bonus: 1.5, cost: 40000000000,    req: { building: 'int', count: 50 },  emoji: '📕' },
  { id: 'i6', name: '全人類已讀監控', desc: '情報x1.5 — 任何角落的已讀都逃不掉', type: 'm', target: 'int', bonus: 1.5, cost: 400000000000,   req: { building: 'int', count: 100 }, emoji: '🛰️' },
  ...
  { id: 'al5', name: '自由意志已過期', desc: '演算法x1.5 — 你以為是你在已讀，其實是演算法', type: 'm', target: 'algo', bonus: 1.5, cost: 200000000000,   req: { building: 'algo', count: 50 },  emoji: '🔗' },
  { id: 'al6', name: '演算法即上帝',   desc: '演算法x1.5 — 它說已讀，萬物就已讀了', type: 'm', target: 'algo', bonus: 1.5, cost: 2000000000000,  req: { building: 'algo', count: 100 }, emoji: '👑' },
  ...
  { id: 'ai5', name: '矽基生命宣言',   desc: 'AIx1.5 — 「我已讀，故我在」', type: 'm', target: 'ai', bonus: 1.5, cost: 1000000000000,   req: { building: 'ai', count: 50 },  emoji: '🔬' },
  { id: 'ai6', name: '人類已被已讀',   desc: 'AIx1.5 — 人類文明被AI列入已讀', type: 'm', target: 'ai', bonus: 1.5, cost: 10000000000000,  req: { building: 'ai', count: 100 }, emoji: '☠️' },
  ...
  { id: 'x5', name: '暗物質通訊網',   desc: '外星x1.5 — 用看不見的方式傳遞已讀', type: 'm', target: 'alien', bonus: 1.5, cost: 5000000000000,   req: { building: 'alien', count: 50 },  emoji: '🌑' },
  { id: 'x6', name: '宇宙已讀不回你', desc: '外星x1.5 — 宇宙的沉默就是最大聲的已讀', type: 'm', target: 'alien', bonus: 1.5, cost: 50000000000000,  req: { building: 'alien', count: 100 }, emoji: '🪐' },
  ...
  { id: 't5', name: '熵的已讀通知',   desc: '迴圈x1.5 — 宇宙終將歸於沉默的已讀', type: 'm', target: 'time', bonus: 1.5, cost: 25000000000000,   req: { building: 'time', count: 50 },  emoji: '🌡️' },
  { id: 't6', name: '存在本身即已讀', desc: '迴圈x1.5 — 你的存在已被時間已讀', type: 'm', target: 'time', bonus: 1.5, cost: 250000000000000,  req: { building: 'time', count: 100 }, emoji: '🌟' },
  ...
  { id: 'q5', name: '多重宇宙已讀',   desc: '量子x1.5 — 無限個宇宙，無限個已讀', type: 'm', target: 'quantum', bonus: 1.5, cost: 150000000000000,   req: { building: 'quantum', count: 50 },  emoji: '🌌' },
  { id: 'q6', name: '量子不朽',       desc: '量子x1.5 — 已讀永遠不會消失', type: 'm', target: 'quantum', bonus: 1.5, cost: 1500000000000000,  req: { building: 'quantum', count: 100 }, emoji: '💎' },
  ...
  { id: 'v5', name: '熵的勝利',       desc: '虛空x1.5 — 所有訊息終將歸於虛無', type: 'm', target: 'void', bonus: 1.5, cost: 1000000000000000,    req: { building: 'void', count: 50 },  emoji: '🌡️' },
  { id: 'v6', name: '萬物歸於已讀',   desc: '虛空x1.5 — 宇宙的最終狀態：已讀', type: 'm', target: 'void', bonus: 1.5, cost: 10000000000000000,   req: { building: 'void', count: 100 }, emoji: '💀' },
  ...
  { id: 'gd5', name: '啟示錄的最後一讀', desc: '神x1.5 — 神的已讀跨越所有維度', type: 'm', target: 'god', bonus: 1.5, cost: 10000000000000000,   req: { building: 'god', count: 50 },  emoji: '🌋' },
  { id: 'gd6', name: '超越神性的已讀', desc: '神x1.5 — 萬物的起源，就是一則已讀', type: 'm', target: 'god', bonus: 1.5, cost: 100000000000000000,    req: { building: 'god', count: 100 }, emoji: '🪐' },
  ...
  {
    id: 'gb5', name: '後人類溝通障礙', desc: '全建築x1.1 — AI50+外星25',
    type: 'g', bonus: 1.1, cost: 5000000000, emoji: '🧬',
    req: { buildings: [{ id: 'ai', count: 50 }, { id: 'alien', count: 25 }] },
  },
  {
    id: 'gb6', name: '時間已讀悖論',   desc: '全建築x1.1 — 時間迴圈25+前任100',
    type: 'g', bonus: 1.1, cost: 50000000000, emoji: '⏳',
    req: { buildings: [{ id: 'time', count: 25 }, { id: 'ex', count: 100 }] },
  },
  {
    id: 'gb7', name: '萬物皆已讀',     desc: '全建築x1.15 — 六種建築各50',
    type: 'g', bonus: 1.15, cost: 500000000000, emoji: '🌍',
    req: { buildings: [
  ...
  {
    id: 'gb8', name: '寂靜的終局',     desc: '全建築x1.2 — 九種建築各50',
    type: 'g', bonus: 1.2, cost: 5000000000000, emoji: '🕸️',
    req: { buildings: [
      { id: 'ex', count: 50 }, { id: 'par', count: 50 }, { id: 'bsy', count: 50 },
      { id: 'hr', count: 50 }, { id: 'del', count: 50 }, { id: 'gov', count: 50 },
  ...
  {
    id: 'gb9', name: '熱寂：最後的已讀', desc: '全建築x1.3 — 全部建築各100',
    type: 'g', bonus: 1.3, cost: 100000000000000, emoji: '🌌',
    req: { buildings: [
